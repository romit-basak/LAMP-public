...
TOOLS = [
    ...
    {"id": "make_test_building", "module": "make_test_building",
     "script": SCRIPTS_DIR / "make_test_building.py",
     "label": "make_test_building.py — synthetic cube+dome+door assets"},
    {"id": "scene3d", "module": "scene3d",
     "script": SCRIPTS_DIR / "scene3d.py",
     "label": "scene3d.py — aperture self-checks on the synthetic assets"},
    {"id": "extract_report_plates", "module": "extract_report_plates",
     "script": SCRIPTS_DIR / "extract_report_plates.py",
     "label": "extract_report_plates.py — dump report scans for plate reading"},
    {"id": "extract_site_plan", "module": "extract_site_plan",
     "script": SCRIPTS_DIR / "extract_site_plan.py",
     "label": "extract_site_plan.py — georeference the site plan, seed doors"},
    {"id": "extract_dxf_plans", "module": "extract_dxf_plans",
     "script": SCRIPTS_DIR / "extract_dxf_plans.py",
     "label": "extract_dxf_plans.py — CAD plan plots for door measurement"},
    {"id": "extract_site_cad", "module": "extract_site_cad",
     "script": SCRIPTS_DIR / "extract_site_cad.py",
     "label": "extract_site_cad.py — measured doors from the site CAD (DWG)"},
    {"id": "read_report_directions", "module": "read_report_directions",
     "script": SCRIPTS_DIR / "read_report_directions.py",
     "label": "read_report_directions.py — OCR entrance directions from the report"},
    {"id": "apertures_from_report", "module": "apertures_from_report",
     "script": SCRIPTS_DIR / "apertures_from_report.py",
     "label": "apertures_from_report.py — stated entrance directions → rows"},
    {"id": "build_aperture_walls", "module": "build_aperture_walls",
     "script": SCRIPTS_DIR / "build_aperture_walls.py",
     "label": "build_aperture_walls.py — registry → per-building OBJ walls"},
